...
menuButton.addEventListener("click", callMenuEvents, false);
menuButton.addEventListener("touchend", callMenuEvents, false);
...
document.addEventListener("click", callDocumentEvents, false);
document.addEventListener("touchend", callDocumentEvents, false);
