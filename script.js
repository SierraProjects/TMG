...
menuButton.addEventListener("click", callMenuEvents, { passive: false });
menuButton.addEventListener("touchstart", callMenuEvents, { passive: false });
...
document.addEventListener("click", callDocumentEvents, { passive: false });
document.addEventListener("touchstart", callDocumentEvents, { passive: false });
